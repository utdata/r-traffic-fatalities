...
### Change some columns that came in as numbers into text.
...
When joining these files, I found I got more observations that the original file. This was because there were multiple spellings for certain counties.

Create a dataframe that is the count of multiple cases. This would happen if there were multiple county_names, which there were, but they hopefully have been fixed above in `glc_state_county`.
