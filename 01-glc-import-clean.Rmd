...
There are a number cases where county names are spelled more than one way. These were found after the join was made with accidents and the join counts didn't match. There are tests after the join.
